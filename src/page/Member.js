        ...
        <div className="container" style={{marginTop: "5%", marginBottom:"2%"}}>
          <div className=" mt-5">
            ...
            <div className="#">
              <div className="row">
                <div className="col">
                  <h2 className="#" style={{fontWeight:"500", textAlign:"center", fontSize:"40px"}} >Data Member</h2>
                </div>
              </div>
            ...
            <input type="text" className="form-control" name="find"
                    ...
                    placeholder="Pencarian berdasarkan gender" />
          </div>
            </div>
            {/* content card */}
            <div className="card-body">
                  ...
                  { this.state.member.map((item) => {
                    return(
                      <tr>
                        ...
                        <td style={{fontWeight:"400", color:"green"}}>NO IMAGE</td> 
              ...
              <button className="btn btn-outline-dark my-2"  onClick={this.Add}>
                <span className="#" ></span> Tambah Member
              </button>
              </center>

              {/* form modal Barang*/}
              <Modal id="modal_member" title="Form Member" bg_header="light" text_header="dark">
